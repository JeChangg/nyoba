		...
		<tbody>
			...
			<?php foreach ($user as $row) : ?>
				<tr>
					...
					<td>
						<a class="btn btn-outline-primary btn-sm" href="ubah_user.php?id=<?= $row["id"]; ?>">Ubah</a> |
						<a class="btn btn-outline-danger btn-sm"  href="hapus_user.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin');">Hapus</a>
					</td>
				</tr>
				<?php $i++; ?>
			<?php endforeach; ?>
